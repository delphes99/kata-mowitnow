...
#Lancement
## Via fichier
La classe MowitApp possède un main qui prends un fichier en paramètre qu'il va traiter.

## Via test unitaire
La classe FinalExample est le test de plus haut niveau. On peut lancer l'ensemble du traitement avec un fichier adapté (dans la variable fileLine)